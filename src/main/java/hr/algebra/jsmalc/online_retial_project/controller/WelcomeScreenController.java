...
public class WelcomeScreenController {
    ...
    public WelcomeScreenController(ProductRepository productRepository) {
    ...
    public String updateProduct(@ModelAttribute("product") Product productToUpdate) {
        Optional<Product> productOptional = productRepository.getProduct(productToUpdate.getId());

        productOptional.ifPresent(product -> productRepository.updateProduct(product, productToUpdate));
